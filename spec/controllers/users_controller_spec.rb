...
describe UsersController do
  ...
  describe "GET 'show'" do
    ...
    it "should have the users name as the heading" do
      get :show, :id => @user
    ...
    it "should display the micropost count" do
      ...
      get :show, :id => @user
      response.should have_selector('.micropost_count', :content => @user.microposts.count.to_s)
    end
  ...
  describe "GET 'new'" do
    ...
    it "should have the right title" do
      get :new
      response.should have_selector("title", :content => "Sign up | #{@base_title}")
    end
  end
  ...
  describe "POST 'create'" do
    ...
    describe "failure" do
      ...
      it "should not create a user" do
        # post to the create action with invalid attributes
        # and have it not add a user in the database
        lambda do
          post :create, :user => @attr 
    ...
    describe "success" do
      ...
      it "should redirect to the user show page" do
        post :create, :user => @attr
        # refer to @user using ' assigns '
        response.should redirect_to(user_path(assigns(:user)))
      end
      
      it "should have a welcome message" do
        post :create, :user => @attr
        flash[:success].should =~ /welcome to watford events/i
      end
  ...
  describe "PUT 'update" do
    ...
    describe "failure" do
      ...
      it "should let the user know theres a problem"
    ...
    describe "success" do
      ...
      before(:each) do
        @attr = { :name => "New name", :email => "new@newname.com", :password => "barbaz", :password_confirmation => "barbaz" }
      end
      ...
      it "should have a flash message to let user know it worked" do
        put :update, :id => @user, :user => @attr
