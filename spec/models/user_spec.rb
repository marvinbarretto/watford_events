...
describe User do
  ...
  it "should accept valid email addresses" do
    addresses = %w[user@foo.com THE_USER@foo.bar.org first.last@foo.co.uk]
  ...
  describe "admin attribute" do
    ...
    it "should not be an admin by default" do
      @user.should_not be_admin # equivalent: @user.admin?.should_not be_true
    end
  ...
  describe "micropost associations" do
    ...
    it "should destroy associated microposts on deletion" do
      @user.destroy
